...
import { TRPCClientError } from '.pnpm/@trpc+client@10.26.0_@trpc+server@10.26.0/node_modules/@trpc/client/src/TRPCClientError';
import { CreateTRPCClientOptions, TRPCRequestOptions, TRPCSubscriptionObserver } from '.pnpm/@trpc+client@10.26.0_@trpc+server@10.26.0/node_modules/@trpc/client/src/internals/TRPCUntypedClient';
import { TRPCClientRuntime } from '.pnpm/@trpc+client@10.26.0_@trpc+server@10.26.0/node_modules/@trpc/client/src/links';
/**
 * @deprecated
 */
