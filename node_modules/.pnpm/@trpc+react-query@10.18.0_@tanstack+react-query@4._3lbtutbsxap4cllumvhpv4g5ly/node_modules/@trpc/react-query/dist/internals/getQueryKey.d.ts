...
import { QueryType } from '.pnpm/@trpc+react-query@10.26.0_khiyoof7ie7jnea6wfwkymtgz4/node_modules/@trpc/react-query/src/internals/getArrayQueryKey';
import { DecorateProcedure, DecoratedProcedureRecord } from '.pnpm/@trpc+react-query@10.26.0_khiyoof7ie7jnea6wfwkymtgz4/node_modules/@trpc/react-query/src/shared';
/**
 ...
 */
export declare function getQueryKey<TProcedureOrRouter extends AnyQueryProcedure | AnyMutationProcedure | AnyRouter, TPath extends string, TFlags>(..._params: GetQueryKeyParams<TProcedureOrRouter, TPath, TFlags>): import(".pnpm/@trpc+react-query@10.26.0_khiyoof7ie7jnea6wfwkymtgz4/node_modules/@trpc/react-query/src/internals/getArrayQueryKey").QueryKey;
export {};
